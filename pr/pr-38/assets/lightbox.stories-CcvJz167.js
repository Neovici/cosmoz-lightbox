 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */class Ze{constructor(t){this.G=t}disconnect(){this.G=void 0}reconnect(t){this.G=t}deref(){return this.G}}let Ke=class{constructor(){this.Y=void 0,this.Z=void 0}get(){return this.Y}pause(){this.Y??=new Promise((t=>this.Z=t))}resume(){this.Z?.(),this.Y=this.Z=void 0}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const re=e=>!we(e)&&typeof e.then=="function",oe=1073741823;let We=class extends me{constructor(){super(...arguments),this._$Cwt=oe,this._$Cbt=[],this._$CK=new Ze(this),this._$CX=new Ke}render(...t){return t.find((s=>!re(s)))??C}update(t,s){const i=this._$Cbt;let n=i.length;this._$Cbt=s;const r=this._$CK,o=this._$CX;this.isConnected||this.disconnected();for(let a=0;a<s.length&&!(a>this._$Cwt);a++){const l=s[a];if(!re(l))return this._$Cwt=a,l;a<n&&l===i[a]||(this._$Cwt=oe,n=0,Promise.resolve(l).then((async f=>{for(;o.get();)await o.get();const b=r.deref();if(b!==void 0){const c=b._$Cbt.indexOf(l);c>-1&&c<b._$Cwt&&(b._$Cwt=c,b.setValue(f))}})))}return C}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}};const E=G(We);function qe(e,...t){return typeof e=="function"?e(...t):e}const Je=e=>fetch(e).then(t=>t.blob()).then(t=>new File([t],"preview.pdf",{type:"application/pdf"})).then(t=>{const s=URL.createObjectURL(t);return setTimeout(()=>{URL.revokeObjectURL(s)},1e3),s}),T=e=>Promise.resolve(qe(e)),D=e=>E(Promise.resolve(e).then(()=>!0,()=>!0),!1),et=e=>{const t=T(e.uri);return u`
		<img
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const rt=e=>e??B,ot=e=>{const t=T(e.uri),{width:s="100%",height:i="100%",sandbox:n,allowfullscreen:r=!0}=e;return u`
		<iframe
...
`;customElements.define("lightbox-spinner",w(at));const lt=()=>u`<lightbox-spinner></lightbox-spinner>`;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ae=(e,t,s)=>{const i=new Map;for(let n=t;n<=s;n++)i.set(e[n],n);return i},ct=G(class extends X{constructor(e){if(super(e),e.type!==q.CHILD)throw Error("repeat() can only be used in text expressions")}dt(e,t,s){let i;s===void 0?s=t:t!==void 0&&(i=t);const n=[],r=[];let o=0;for(const a of e)n[o]=i?i(a,o):o,r[o]=s(a,o),o++;return{values:r,keys:n}}render(e,t,s){return this.dt(e,t,s).values}update(e,[t,s,i]){const n=$e(e),{values:r,keys:o}=this.dt(t,s,i);if(!Array.isArray(n))return this.ut=o,r;const a=this.ut??=[],l=[];let f,b,c=0,p=n.length-1,d=0,g=r.length-1;for(;c<=p&&d<=g;)if(n[c]===null)c++;else if(n[p]===null)p--;else if(a[c]===o[d])l[d]=$(n[c],r[d]),c++,d++;else if(a[p]===o[g])l[g]=$(n[p],r[g]),p--,g--;else if(a[c]===o[g])l[g]=$(n[c],r[g]),I(e,l[g+1],n[c]),c++,g--;else if(a[p]===o[d])l[d]=$(n[p],r[d]),I(e,n[c],n[p]),p--,d++;else if(f===void 0&&(f=ae(o,d,g),b=ae(a,c,p)),f.has(a[c]))if(f.has(a[p])){const h=b.get(o[d]),m=h!==void 0?n[h]:null;if(m===null){const v=I(e,n[c]);$(v,r[d]),l[d]=v}else l[d]=$(m,r[d]),I(e,n[c],m),n[h]=null;d++}else V(n[p]),p--;else V(n[c]),c++;for(;d<=g;){const h=I(e,l[g+1]);$(h,r[d]),l[d++]=h}for(;c<=p;){const h=n[c++];h!==null&&V(h)}return this.ut=o,_e(e,l),C}}),Z=new WeakMap,ht=G(class extends me{render(e){return B}update(e,[t]){const s=t!==this.G;return s&&this.G!==void 0&&this.rt(void 0),(s||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),B}rt(e){if(this.isConnected||(e=void 0),typeof this.G=="function"){const t=this.ht??globalThis;let s=Z.get(t);s===void 0&&(s=new WeakMap,Z.set(t,s)),s.get(this.G)!==void 0&&this.G.call(this.ht,void 0),s.set(this.G,e),e!==void 0&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){return typeof this.G=="function"?Z.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ge="important",dt=" !"+ge,ut=G(class extends X{constructor(e){if(super(e),e.type!==q.ATTRIBUTE||e.name!=="style"||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,s)=>{const i=e[s];return i==null?t:t+`${s=s.includes("-")?s:s.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${i};`}),"")}update(e,[t]){const{style:s}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(const i of this.ft)t[i]==null&&(this.ft.delete(i),i.includes("-")?s.removeProperty(i):s[i]=null);for(const i in t){const n=t[i];if(n!=null){this.ft.add(i);const r=typeof n=="string"&&n.endsWith(dt);i.includes("-")||r?s.setProperty(i,r?n.slice(0,-11):n,r?ge:""):s[i]=n}}return C}});/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const pt={},be=G(class extends X{constructor(){super(...arguments),this.ot=pt}render(e,t){return t()}update(e,[t,s]){if(Array.isArray(t)){if(Array.isArray(this.ot)&&this.ot.length===t.length&&t.every(((i,n)=>i===this.ot[n])))return C}else if(this.ot===t)return C;return this.ot=Array.isArray(t)?Array.from(t):t,this.render(t,s)}});class ft extends Promise{constructor(t){const s={};super((i,n)=>Object.assign(s,{resolve:i,reject:n})),Object.assign(this,s),t?.(s.resolve,s.reject)}resolve=()=>{}}const ve={host:{position:"relative",display:"flex",overflow:"hidden"},slide:{position:"static",width:"100%",height:"100%"}},mt=e=>{const{slide:t}=e,[s,i]=pe([]);return ne(()=>void Object.assign(e.style,ve.host),[]),H(()=>{if(t==null)return;const n={animationEnd$:new ft,...t};i((r=[])=>{const o=r.findIndex(({id:a,out:l})=>a===n.id&&l!==!0);return o!==-1?[...r.slice(0,o),n,...r.slice(o+1,r.length)]:[...r,n]})},[t]),ne(async()=>{if(s.filter(l=>!l.out).length<2){const l=s[0];l&&requestAnimationFrame(()=>requestAnimationFrame(()=>l.animationEnd$.resolve()));return}const n=s[s.length-1],r=s[s.length-2],o=n.el,a=r.el;r.out=!0,o&&a&&await n.animation?.(o,a),i((l=[])=>l.filter(f=>f!==r))},[s]),{slides:s}},gt=e=>u`<div
		${ht(t=>Object.assign(e,{el:t}))}
		class="slide"
		style=${ut(ve.slide)}
	>
		${be([e],()=>e.content??e.render?.(e))}
	</div>`,bt=({slides:e})=>be([e],()=>ct(e,({id:t})=>t,gt)),vt=e=>bt(mt(e));customElements.define("cosmoz-slider",w(vt,{useShadowDOM:!1}));const W=(e,t)=>{const s=e.animate([{position:"absolute",transform:"translateX(100%)"},{transform:"translateX(0%)"}],{duration:200,fill:"none",easing:"ease-in-out"}),i=t.animate([{},{position:"absolute",transform:"translateX(-100%)"}],{duration:200,fill:"none",easing:"ease-in-out"});return Promise.all([s.finished,i.finished])},le=(e,t)=>{const s=e.animate([{position:"absolute",transform:"translateX(-100%)"},{transform:"translateX(0%)"}],{duration:200,fill:"none",easing:"ease-in-out"}),i=t.animate([{},{position:"absolute",transform:"translateX(100%)"}],{duration:200,fill:"none",easing:"ease-in-out"});return Promise.all([s.finished,i.finished])},yt=e=>{const t=De(void 0);return H(()=>void(t.current=e),[e]),t.current},xt=e=>e,wt=(e,t,s)=>e.find(i=>s(i)===s(t))??e[0],$t=()=>({id:Math.random(),content:B,animation:W}),_t=(e,{initial:t,render:s,id:i=xt,loop:n})=>{const[r,o]=pe(()=>t??e[0]),a=k(()=>e.indexOf(r),[e,r]),l=yt(a),f=Q(()=>o(()=>n?e[(a-1+e.length)%e.length]:e[Math.max(0,Math.min(e.length-1,a-1))]),[e,a,n]),b=Q(()=>o(()=>n?e[(a+1)%e.length]:e[Math.max(0,Math.min(e.length-1,a+1))]),[e,a,n]),c=Q(h=>o(()=>e[h]),[e]),p=n?!1:a<=0,d=n?!1:a===e.length-1,g=a>(l??-1)?n&&a===e.length-1&&l===0?le:W:n&&a===0&&l===e.length-1?W:le;return H(()=>o(h=>h?e.indexOf(h)>=0?h:wt(e,h,i):e[0]),[e]),{index:a,item:r,slide:k(()=>r==null?$t():{id:i(r),render:h=>s(r,{next:b,prev:f,goto:c,first:p,last:d,...h}),animation:g},[r,s]),prev:f,next:b,goto:c,first:p,last:d}},Ct=e=>{const t=k(()=>({}),[]);return k(()=>Object.assign(t,e),[t,...Object.values(e)])},kt=(e,{next:t,prev:s,first:i,last:n})=>u`<div class="canvas">
