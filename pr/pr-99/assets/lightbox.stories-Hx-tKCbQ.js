...
`;class Ze{constructor(t){this.G=t}disconnect(){this.G=void 0}reconnect(t){this.G=t}deref(){return this.G}}let Ke=class{constructor(){this.Y=void 0,this.Z=void 0}get(){return this.Y}pause(){this.Y??=new Promise(t=>this.Z=t)}resume(){this.Z?.(),this.Y=this.Z=void 0}};const re=e=>!we(e)&&typeof e.then=="function",oe=1073741823;let We=class extends me{constructor(){super(...arguments),this._$Cwt=oe,this._$Cbt=[],this._$CK=new Ze(this),this._$CX=new Ke}render(...t){return t.find(s=>!re(s))??A}update(t,s){const i=this._$Cbt;let n=i.length;this._$Cbt=s;const r=this._$CK,o=this._$CX;this.isConnected||this.disconnected();for(let a=0;a<s.length&&!(a>this._$Cwt);a++){const l=s[a];if(!re(l))return this._$Cwt=a,l;a<n&&l===i[a]||(this._$Cwt=oe,n=0,Promise.resolve(l).then(async f=>{for(;o.get();)await o.get();const b=r.deref();if(b!==void 0){const c=b._$Cbt.indexOf(l);c>-1&&c<b._$Cwt&&(b._$Cwt=c,b.setValue(f))}}))}return A}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}};const E=G(We),qe=(e,...t)=>typeof e=="function"?e(...t):e,Je=e=>fetch(e).then(t=>t.blob()).then(t=>new File([t],"preview.pdf",{type:"application/pdf"})).then(t=>{const s=URL.createObjectURL(t);return setTimeout(()=>{URL.revokeObjectURL(s)},1e3),s}),T=e=>Promise.resolve(qe(e)),D=e=>E(Promise.resolve(e).then(()=>!0,()=>!0),!1),et=e=>{const t=T(e.uri);return u`
		<img
